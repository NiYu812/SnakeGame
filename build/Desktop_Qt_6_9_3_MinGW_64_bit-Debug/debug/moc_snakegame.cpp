...
void SnakeGame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->moveSnake(); break;
        case 3: _t->spawnFood(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SnakeGame::*)(int )>(_a, &SnakeGame::scoreChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SnakeGame::*)(int )>(_a, &SnakeGame::gameOver, 1))
            return;
    }
}
...
// SIGNAL 0
void SnakeGame::scoreChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void SnakeGame::gameOver(int _t1)
{
